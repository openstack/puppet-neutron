...
describe 'neutron::plugins::plumgrid' do
  ...
  shared_examples_for 'neutron plumgrid plugin' do
    ...
    it 'should perform default configuration of plumgrid plumlib' do
      ...
      is_expected.to contain_neutron_plumlib_plumgrid('l2gateway/vendor').with_value(params[:l2gateway_vendor])
      is_expected.to contain_neutron_plumlib_plumgrid('l2gateway/sw_username').with_value(params[:l2gateway_sw_username])
      is_expected.to contain_neutron_plumlib_plumgrid('l2gateway/sw_password').with_value(params[:l2gateway_sw_password])
    end
